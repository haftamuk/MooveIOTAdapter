// File: UT04SAdapter/node_modules/gps-tracking/lib/server.js
...
function Server(opts, callback) {
  ...
  this.init = function (cb) {
    ...
    if (typeof _this.opts.device_adapter === 'string') {
      ...
      //Get the adapter
      console.log("this.opts.device_adapter : " + this.opts.device_adapter);
  ...
  this.init(function () {
    ...
    _this.server = net.createServer(function (connection) {
      ...
      console.log("=================================")
      console.log("============= SERVER.JS Adding a new device=========")
      console.log(_this.getAdapter()); 
      console.log("=================================")
      ...
      connection.on('data', function (data) {
        console.log("=================================")
        console.log("============= SERVER.JS EMIT ON-DATA=========")
      ...
      connection.on('end', function () {
        console.log("=================================")
        console.log("============= SERVER.JS EMIT ON-END=========")
        console.log("=================================")
      ...
      console.log("=================================")
      console.log("============= SERVER.JS EMIT ON-CONNECTED=========")
      console.log("=================================")
